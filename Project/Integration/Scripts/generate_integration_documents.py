    ...
    story = [
        ...
        styled_table(
            [
                ...
                ["Print_Plate_01_Hull.3mf", "3 hull modules + shafts/struts/rudders; no props", "220.06 × 177.29 × 31.43"],
                ...
                ["Print_Plate_04_Propellers.3mf", "4 flat five-blade propellers", "38.04 × 7.12 × 2.08"],
        ...
        bullet("The four propellers use a common flat bed-side face and 0.60 mm blades. Print Plate 04 at 0.12 or 0.16 mm with three walls and a 3 mm brim; supports and a sprue are not required."),
...
def main():
    ...
    paths = [
        ...
        INTEGRATION / "CAD" / "Python" / "propeller_parameters.py",
        INTEGRATION / "QA" / "Bambu_Profiles" / "CVN69_A1_0p4_Machine_Validation.json",
        INTEGRATION / "QA" / "Bambu_Profiles" / "CVN69_A1_0p12_Propeller_Validation.json",
        INTEGRATION / "QA" / "Bambu_Profiles" / "CVN69_A1_0p16_Propeller_Validation.json",
